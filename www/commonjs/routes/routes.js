var routes = [
  ...
  // user-submit-exam page
  {
    path: '/user-submit-exam/',
    ...
    content: '\
      <div class="page">\
        ...
        <div class="page-content">\
          <div class="block">\
            <p>T11his is a right panel page 1</p>\
    ...
    tabs: [
      {
        ...
        <div class="block"> \
          <p>Tab 1 content</p> \
          <p>1111Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ullam enim quia molestiae facilis laudantium voluptates obcaecati officia cum, sit libero commodi. Ratione illo suscipit temporibus sequi iure ad laboriosam accusamus?</p> \
